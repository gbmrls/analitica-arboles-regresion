...
Teniendo nuestras variables con mayor correlación vamos a gráficarlas con geom point, se puede observar fácilmente que a mayor diametro de rotor , mayor es la capacidad rated de la turbina:

- Creciente para rotor diamater_m y turbine_rated_capacity_k_w
